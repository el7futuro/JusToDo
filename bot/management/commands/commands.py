...
class BotCommands:
    ...
    def get_goals_list(self):
        goals = Goal.objects.filter(
            Q(category__board__participants__user__id=self.user.user.id)
    ...
    def create_goal(self, offset) -> int:
        ...
        goal = Goal(
            title=self.goal_title, category=self.goal_category, description=self.goal_description, user=self.user.user,
